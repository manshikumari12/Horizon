...
function StudentLogin() {
 ...
 <div className="main-container min-h-screen flex flex-col items-center justify-center bg-blue-50"> {/* Added background to main container */}
  <LoginToggle />
  
  <div className="w-full max-w-md bg-white shadow-2xl border border-gray-300 p-8 rounded-lg mt-6">
    <h3 className="text-2xl font-bold mb-4 text-center text-blue-600">Student Login</h3>
